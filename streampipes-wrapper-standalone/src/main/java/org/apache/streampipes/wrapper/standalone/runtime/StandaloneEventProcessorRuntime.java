...
public class StandaloneEventProcessorRuntime
  ...
  public SpOutputCollector getOutputCollector() throws SpRuntimeException {
    return ProtocolManager.findOutputCollector(
            runtimeParameters.getModel().getOutputStream().getEventGrounding().getTransportProtocol(),
            runtimeParameters.getModel().getOutputStream().getEventGrounding().getTransportFormats().get(0),
            this.instanceId);
  }
