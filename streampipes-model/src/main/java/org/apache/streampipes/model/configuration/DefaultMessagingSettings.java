...
public class DefaultMessagingSettings {
  ...
  public MessagingSettings make() {
    ...
    var defaultSettings = new MessagingSettings(1638400, 5000012, 20, 2,
            Arrays.asList(SpDataFormat.JSON, SpDataFormat.CBOR, SpDataFormat.FST, SpDataFormat.SMILE), protocolList);
